...
<template>
  <EditListTable :items="items">
    ...
    <template #tableHeader>
      ...
      <TableHeaderCell>SyncDataApiUrl</TableHeaderCell>
    </template>
    ...
    >
      ...
      <TableCell>
        <UrlCell :text="item.syncdataapiurl" :editable="false" />
      </TableCell>
    </template>
...
const { addItem, updateItem } = useInjectActionTriggers<SyncDataConfigEntry>();
