...
import { Size, Tone, Variant } from '@/components/button/types.ts';
...
import { injectColumnConfiguration } from '@/domain/datasets/ui/tableView/toolBox/configureTableColumns/columnConfiguration.ts';
import { Variant as InputVariant } from '@/components/input/types.ts';
